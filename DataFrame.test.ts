...
describe("Testing data-frame behavior", () => {
    ...
    describe("Row and column functions", () => {
        ...
        describe("replacing rows and columns", () => {
            const dataFrame = DataFrame.from([
                [1, 2, 3],
                [4, 5, 6],
                [7, 8, 9],
            ...
            test("should be able to replace the first row in a data-frame", () => {
                const expected = DataFrame.from([
                    [10, 20, 30],
                    [4, 5, 6],
                    [7, 8, 9],
                ...
                const updated = dataFrame.replaceRow(0, [10, 20, 30])
                expect(updated).toEqual(expected)
                expect(updated).not.toEqual(dataFrame)
            })

            test("should be able to replace the last row in a data-frame", () => {
                const expected = DataFrame.from([
                    [1, 2, 3],
                    [4, 5, 6],
                    [7, 8, 9],
                ...
                const updated = dataFrame.replaceRow(3, [101, 111, 121])
                expect(updated).toEqual(expected)
                expect(updated).not.toEqual(dataFrame)
            })

            test("should be able to replace a middle row in a data-frame", () => {
                const expected = DataFrame.from([
                    [1, 2, 3],
                    [42, 52, 62],
                    [7, 8, 9],
                ...
                const updated = dataFrame.replaceRow(1, [42, 52, 62])
                expect(updated).toEqual(expected)
                expect(updated).not.toEqual(dataFrame)
            })

            test("should be able to replace the first column in a data-frame", () => {
                const expected = DataFrame.from([
                    [10, 2, 3],
                    [40, 5, 6],
                    [70, 8, 9],
                ...
                const updated = dataFrame.replaceColumn(0, [10, 40, 70, 100])
                expect(updated).toEqual(expected)
                expect(updated).not.toEqual(dataFrame)
            })

            test("should be able to replace the last column in a data-frame", () => {
                const expected = DataFrame.from([
                    [1, 2, 30],
                    [4, 5, 60],
                    [7, 8, 90],
                ...
                const updated = dataFrame.replaceColumn(2, [30, 60, 90, 120])
                expect(updated).toEqual(expected)
                expect(updated).not.toEqual(dataFrame)
            })

            test("should be able to replace a middle column in a data-frame", () => {
                const expected = DataFrame.from([
                    [1, 21, 3],
                    [4, 51, 6],
                    [7, 81, 9],
                ...
                const updated = dataFrame.replaceColumn(1, [21, 51, 81, 111])
                expect(updated).toEqual(expected)
                expect(updated).not.toEqual(dataFrame)
            })
        })
